...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'father_name' => ['nullable', 'required_without_all:mother_name,guardian_name', 'string', 'max:255', 'regex:/^[\pL\s.\'-]+$/u'],
            'mother_name' => ['nullable', 'required_without_all:father_name,guardian_name', 'string', 'max:255', 'regex:/^[\pL\s.\'-]+$/u'],
