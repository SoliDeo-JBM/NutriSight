            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="toggleCurrentPassword" aria-label="Show password" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-orange-600 transition-colors focus:outline-none">
                            <i id="eyeCurrentIcon" class="fas fa-eye"></i>
                            <i id="eyeSlashCurrentIcon" class="fas fa-eye-slash hidden"></i>
                        </button>
                    </div>
