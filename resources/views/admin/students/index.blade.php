...
@section('content')
    <div class="flex flex-col gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form method="GET" action="{{ route('admin.students.index') }}" class="space-y-4" x-data>
                <!-- Search Bar -->
                <div>
                ...
                <div class="flex justify-end pt-1">
                    <a href="{{ route('admin.students.index') }}" class="text-sm text-gray-600 hover:text-blue-600 inline-flex items-center gap-2">
