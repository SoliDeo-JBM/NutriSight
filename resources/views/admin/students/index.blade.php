...
<div class="flex flex-col gap-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="GET" action="{{ route($routePrefix . '.students.index') }}" class="space-y-4" x-data>
            <!-- Search Bar -->
            <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="bmi_category" @change="$el.form.requestSubmit()" class="w-full border border-gray-300 rounded-lg p-2.5 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                        ...
                        <option value="{{ $category }}" {{ request('bmi_category') === $category ? 'selected' : '' }}>{{ $category }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="flex justify-end pt-1">
                <a href="{{ route($routePrefix . '.students.index') }}" class="text-sm text-gray-600 hover:text-blue-600 inline-flex items-center gap-2">
        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    $baselineRecord = $enrollment?->sbfpParticipant?->nutritionMeasurements
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 border">{{ $baselineRecord->hfa ?? 'Normal' }}</td>
