...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #334155; padding: 20px;">
    ...
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 24px;">
        ...
        <p style="margin: 24px 0; text-align: center;"><a href="{{ $approvalUrl }}" style="display: inline-block; background: #2563eb; color: #ffffff; padding: 12px 18px; border-radius: 6px; text-decoration: none; font-weight: bold;">Review and Respond</a></p>
