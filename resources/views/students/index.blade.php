...
@section('content')
    <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('students.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded text-sm hover:bg-blue-700 inline-flex items-center gap-2 whitespace-nowrap font-semibold">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form method="GET" action="{{ route('students.index') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nutritional Status</label>
            ...
            <div class="overflow-x-auto shadow ring-1 ring-black ring-opacity-5 rounded-lg">
                <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @empty
                        <tr>
                            <td colspan="15" class="px-4 py-6 border text-center text-gray-500">No students found matching your criteria. Click "Add Advisory Student" to begin.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
