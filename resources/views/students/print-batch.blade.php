...
<body>
    ...
    <div class="page">
        ...
        <div class="id-landscape">
            <img class="id-logo" src="{{ \App\Services\SchoolLogoService::url() }}" alt="MBES logo">
            ...
            <img class="id-background-logo" src="{{ \App\Services\SchoolLogoService::url() }}" alt="">
