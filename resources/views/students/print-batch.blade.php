...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        @media print { .no-print { display: none !important; } body { margin: 0; padding: 0; background: white; } .page { page-break-after: always; box-shadow: none !important; } }
        ...
        .id-landscape { position: relative; width: 324px; height: 204px; overflow: hidden; background: #fff5f5; border: 1px dashed #64748b; border-radius: 5px; color: #111827; }
        .id-header { position: absolute; z-index: 4; top: 15px; left: 0; width: 100%; height: 30px; background: #1818ef; color: white; text-align: left; padding: 6px 8px 4px 70px; font-size: 9px; font-weight: 700; line-height: 10px; opacity: 1; }
